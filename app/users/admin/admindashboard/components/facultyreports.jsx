  ...
  const generatePDF = () => {
    ...
    autoTable(doc, {
      ...
      didParseCell: (data) => {
        if (
          ...
          data.cell.colSpan = 9; // ✅ span all columns if no data
        }
      },
      columnStyles: {
        0: { cellWidth: 28 }, // Faculty
        1: { cellWidth: 36 }, // Student name
        2: { cellWidth: 24 }, // Subject
        3: { cellWidth: 28 }, // Purpose
        4: { cellWidth: 32 }, // Schedule date
        5: { cellWidth: 30 }, // Time range
        6: { cellWidth: 24 }, // Status
        7: { cellWidth: 32 }, // Discussion
        8: { cellWidth: 36 }, // Recommendation
      },
    });
    ...
    if (filteredConsultations.length > 0) {
      ...
      const authorizedName =
        filteredConsultations[0].faculty_name || "Authorized Name";
    ...
    >
      <div className="bg-white p-6 shadow-md">
        ...
        <p className="text-gray-600 text-sm mb-6">
          ...
          their current status — completed and cancelled. Below, the
