  ...
  return (
    ...
    >
      <div className="bg-white p-6  shadow-md">
        <h1 className="text-lg font-bold mb-4 text-green-800 pb-5 mt-3 flex items-center gap-2">
          <TbCalendarTime className="w-6 h-6 !w-6 !h-6" />
          Faculty Consultation Overview
        </h1>
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Fill in the consultation details below and click save to add
                  it.
                </DialogDescription>
              </DialogHeader>
        ...
        <table className="w-full border-collapse bg-white shadow-lg      overflow-hidden">
          <thead className="bg-green-900 text-white">
            <tr>
              {["Student", "Day", "Time", "Status", "Actions"].map(
                (header, index) => (
                  <th
                    key={index}
