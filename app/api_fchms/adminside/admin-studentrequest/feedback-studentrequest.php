...
try {
    ...
    // For now, if there's no schedulebookings_id, we'll skip feedback insertion
    // You may want to create a tbl_booking_feedback table or adjust this logic
    if ($booking['schedulebookings_id']) {
        ...
        echo json_encode([
            "success" => false,
            "message" => "Booking has not been scheduled yet. Please schedule the consultation first."
        ]);
    }
} catch (Exception $e) {
    echo json_encode([
