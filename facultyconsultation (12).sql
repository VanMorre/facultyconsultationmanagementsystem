...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2026 at 03:42 AM
...
(85, 15, 'Add-Availabilityschedule', 'Set faculty availability (Availability: 6, TimeRange: 7)', '2026-01-03 02:37:57'),
(86, 15, 'Booking Completion', 'Completed booking (ID: 81) with discussion and recommendation', '2026-01-03 02:39:57');
...
(12, 'banbanguangco', 23, '09972664749', 'uploads/1766740918_manphoto.png', 'banbanguangco@phinmaed.com', '2ffa170e19a75ff8859e95ac0ed5edbdec1f4e41', 1, 4, 3, '2025-12-26 17:21:58', '2026-01-03 09:56:47'),
(14, 'keithcaparas', 24, '09838531285', 'uploads/1767407438_manphoto.png', 'keithcaparases@phinmaed.com', 'ad26d4354d3201005d17106546a1c67b6a3023c1', 1, 4, 3, '2026-01-03 10:30:38', '2026-01-03 10:34:43');
...
--
ALTER TABLE `tbl_scheduledbookings`
  MODIFY `schedulebookings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `tbl_setavailabilityfaculty`
--
ALTER TABLE `tbl_setavailabilityfaculty`
  MODIFY `availabilityfaculty_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
